...
![SUCI Format](../../../docs/assets/lte/suci_format.png?raw=true "SUCI Format")
...
- While creating the LTE network, SUCI Profiles can be established using the below swagger API.
  ...
  ![Create New LTE Network with SuciProfile](../../../docs/assets/lte/create_new_lte_network_with_suciprofile.png?raw=true "Create New LTE Network with SuciProfile")
...
- If we want to add a SUCI Profile to an existing LTE network, we may do it with the swagger API listed below.
  ...
  ![Update Existing LTE Network with SuciProfile](../../../docs/assets/lte/update_existing_lte_network_with_suciprofile.png?raw=true "Update Existing LTE Network with SuciProfile")
